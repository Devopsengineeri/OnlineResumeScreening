          ...
          <tbody>
            {candidates?.length > 0 ? (
              candidates.map((candidate) => (
                <tr
                  key={candidate._id}
                  onClick={() => setSelectedCandidate(candidate)} // ✅ click handler
                ...
                >
                  ...
                  <td className="px-1 py-2">
                    <div
                      onClick={(e) => e.stopPropagation()} // ✅ Prevent modal on scheduler click
                    >
                      <InterviewScheduler
                        candidateId={candidate._id}
                        interviewId={candidate.interviewId}
                        onSchedule={() => console.log("Interview scheduled")}
                      />
                    </div>
                  </td>
                </tr>
